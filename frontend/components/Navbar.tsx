  ...
  return (
    <header className="w-full bg-white shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex justify-between items-center">
        ...
        {/* Links */}
        <nav className="hidden md:flex gap-8 text-sm font-medium text-[#5C2E2E]">
          <span className="cursor-pointer hover:text-[#8B3232] transition-colors">Home</span>
          <span className="cursor-pointer hover:text-[#8B3232] transition-colors">Shop</span>
          <span className="cursor-pointer hover:text-[#8B3232] transition-colors">Categories</span>
          <span className="cursor-pointer hover:text-[#8B3232] transition-colors">About</span>
          <span className="cursor-pointer hover:text-[#8B3232] transition-colors">Contact</span>
        </nav>
